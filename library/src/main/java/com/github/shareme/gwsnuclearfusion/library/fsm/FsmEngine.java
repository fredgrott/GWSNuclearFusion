 ...
 *
 */
package com.github.shareme.gwsnuclearfusion.library.fsm;
...
public class FsmEngine<E,T> {
    ...
    private FSMObserver<E> mObserver;
     ...
     *
     * @param onTrigger the onTrigger
     * @param fromState the fromState
     */
     ...
     *
     * @param startingState the startingState
     * @return start
     */
     ...
     *
     * @param startingState the startingState
     * @param optionalInputData the optionalInputData
     ...
     *
     * @param triggerEnum the triggerEnum
     * @param optionalInputData can be null. If this trigger defines an {@link Action} via {@link FsmEngine.Trigger#setAction(Action)}
     *                          then this data object will be passed to that actions. If this trigger defines a
     *                          {@link FsmEngine.Trigger#setToState(Object)} this data object will be
     ...
     * - An event that trigger an {@link FsmEngine.Action} based upon the existing state.
     * - Both of the above.
     *
     * @param <E>
     * @param <T>
    ...
    public static class Trigger<E, T>
    {
         ...
         * Optional.
         *
         * @param transitionAction the transitionAction
         */
         ...
         *
         * @param requiredDataType the requiredDateType
         * @return this instance
         */
    ...
    public abstract static class Action
    {
        ...
        public <C> C getOptionalInputDataAs(Class<C> clazz)
        {
            ...
            {
                throw new RuntimeException("Trying to cast "+" to "+clazz.getName());
            }
        }
    ...
    public interface FSMObserver<E>
    {
        /**
     ...
     */
    public void addObserver(FSMObserver<E> observer)
    {
