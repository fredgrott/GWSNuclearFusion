 ...
 *
 */
package com.github.shareme.gwsnuclearfusion.library.state;
...
/**
 * GsonHelper
 * Created by fgrott on 12/18/2015.
 */
...
public class GsonHelper {
    ...
    public static String toJson(Object obj) {
        try {
            ...
            Timber.e("GsonHelper", "Cannot convert object to JSON", e);
            return null;
        }
    }
    ...
    public static <T> T fromJson(String str, Type type) {
        try {
            ...
            Timber.e("GsonHelper", "Cannot parse JSON to object", e);
            return null;
        }
    }
